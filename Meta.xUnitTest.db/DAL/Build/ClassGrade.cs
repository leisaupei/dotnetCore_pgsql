...
namespace Meta.xUnitTest.DAL
{
	public sealed partial class ClassGrade : SelectBuilder<ClassGrade, ClassGradeModel>
	{
		...
		#region Insert
		public static int Commit(ClassGradeModel model) => GetInsertBuilder(model).ToRows();
		...
		public static IEnumerable<ISqlBuilder> GetSqlBuilder(IEnumerable<ClassGradeModel> models, bool isExceptionCancel)
		{
		...
		public static InsertBuilder<ClassGradeModel> GetInsertBuilder(ClassGradeModel model)
		{
			if (model == null)
