...
namespace DBHelper
{
	public class TypeHelper
	{
		...
		public static NpgsqlDbType ConvertDbTypeToNpgsqlDbTypeEnum(string data_type, string db_type)
		{
			if (data_type == "e")
		...
		{
			string[] arr = new string[] { "datetime", "geometry", "JToken" };
			if (arr.Contains(type.Replace("?", "")))
				return false;
			return true;
		}
		//从数据库类型获取where条件字段类型
